...
import { Card, CardContent, CardMedia, Typography, Grid, CardActions, Button, Chip } from '@mui/material';
        ...
        <Grid item xs={12} sm={6} md={4} key={recipe.id}>
          <Card elevation={4}>
            ...
            <CardContent>
              ...
              <Chip label={recipe.dietaryInfo} color="primary" style={{ backgroundColor: pink[100] }} />
            </CardContent>
            <CardActions>
              <Button size="small" color="primary" href={recipe.recipeLink} target="_blank" style={{ color: blue[500] }}>
                View Recipe
              </Button>
            </CardActions>
          </Card>
